...
class PropertyModel(models.Model):
    ...
    furnishing_status = models.CharField(max_length=12, choices=FURNISHING_TYPE_CHOICES)
    ...
    postion = models.CharField(max_length=2, choices=POSITION_TYPE_CHOICES)
